---
title: Building an AI Agent - Role
...
Navigate to the prompt writing section and click the **'Ask Copilot'** button.
![Copilot Step 1](./images/copilot%201%20(1).png)

### Step 2: Engage with Copilot
A chatbox will appear to guide you through creating your prompt. Provide detailed answers to the questions Copilot asks to help it understand your needs.
![Copilot Step 2](./images/copilot%202.png)

### Step 3: Review and Insert Your Prompt
Review the generated prompt, make any necessary adjustments, and click the **'Insert'** button to add it to your designated area.
![Copilot Step 3](./images/copilot%203.png)

### Step 4: Test Your AI Agent
Click the **'Test Agent'** button in the top right corner to see your AI agent in action.

## Using Templates for AI Agents

### Step 1: Click on "Use Template"
- Once in the **Role** section, you’ll see an option labeled **Use Template**, click on it.

### Step 2: Select a Template
- A pop-up window will appear showing various pre-made AI agent templates designed for different use cases (e.g., customer support, appointment booking, etc.).
- Browse through the list of templates and click on **Select Template** for the one that fits your needs.

### Step 3: Review or Customize the Template
- Once you’ve selected a template, the pre-defined prompts will automatically update in the **Prompt** section of the AI agent.
- You can either:
    - **Proceed with the selected template as is** if it meets your requirements, or
    - **Make changes** to the template by editing the prompts to better suit your specific use case.
