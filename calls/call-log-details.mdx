...
description: Check the call logs of your voice AI agent, whether it is incoming call, outgoing call and call made from phone number or widget.
---

## Accessing the Calls Feature
...
2. **View Call Overview and Analysis**
    ...
    - For a deeper dive, click on **Detailed Call Analysis** to understand more about the call's specifics.
...
<Frame>
![1724992791386-679747.png](images/1724992791386-679747.png)
</Frame>